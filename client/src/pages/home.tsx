        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10 grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4">
              ...
              <Link href="/login">
                <Button size="lg" variant="outline" className="w-full sm:w-auto h-14 px-8 text-base sm:text-lg font-bold rounded-full border-muted-foreground/30 hover:bg-white/5 active:scale-95 transition-all touch-manipulation" data-testid="button-login">
                  {t("home", "login")}
                </Button>
              </Link>
            </div>
